...
/*___________________________________________________________________________
 |                                                                           |
 |   Function Name : round_fixed                                                   |
 |                                                                           |
 |   Purpose :                                                               |
 |                                                                           |
 |   round_fixed the lower 16 bits of the 32 bit input number into its MS 16 bits  |
 |   with saturation. Shift the resulting bits right by 16 and return the 16 |
 |   bit number:                                                             |
 |               round_fixed(L_var1) = extract_h(L_add(L_var1,32768))              |
 |                                                                           |
 |   Complexity weight : 1                                                   |
 |                                                                           |
 |   Inputs :                                                                |
...
Word16 round_fixed(Word32 L_var1)
  {
   Word16 var_out;
   Word32 L_arrondi;
...
/*___________________________________________________________________________
 ...
 |   Purpose :                                                               |
 |                                                                           |
 |   Same as mult with round_fixeding, i.e.:                                       |
...
Word16 mult_r(Word16 var1, Word16 var2)
  {
   ...
   L_produit_arr += (Word32) 0x00004000;        /* round_fixed */
...
/*___________________________________________________________________________
 ...
 |   Purpose :                                                               |
 |                                                                           |
 |   Same as shr(var1,var2) but with round_fixeding. Saturate the result in case of|
 |   underflows or overflows :                                               |
...
/*___________________________________________________________________________
 ...
 |                                                                           |
 |   Multiply var1 by var2 and shift the result left by 1. Add the 32 bit    |
 |   result to L_var3 with saturation. round_fixed the LS 16 bits of the result    |
 |   into the MS 16 bits with saturation and shift the result right by 16.   |
 |   Return a 16 bit result.                                                 |
 |            mac_r(L_var3,var1,var2) = round_fixed(L_mac(Lvar3,var1,var2))        |
 |                                                                           |
 |   Complexity weight : 2                                                   |
 |                                                                           |
 |   Inputs :                                                                |
...
/*___________________________________________________________________________
 ...
 |                                                                           |
 |   Multiply var1 by var2 and shift the result left by 1. Subtract the 32   |
 |   bit result to L_var3 with saturation. round_fixed the LS 16 bits of the res-  |
 |   ult into the MS 16 bits with saturation and shift the result right by   |
 |   16. Return a 16 bit result.                                             |
 |            msu_r(L_var3,var1,var2) = round_fixed(L_msu(Lvar3,var1,var2))        |
 |                                                                           |
 |   Complexity weight : 2                                                   |
 |                                                                           |
 |   Inputs :                                                                |
...
/*___________________________________________________________________________
 ...
 |   Purpose :                                                               |
 |                                                                           |
 |   Same as L_shr(L_var1,var2)but with round_fixeding. Saturate the result in case|
